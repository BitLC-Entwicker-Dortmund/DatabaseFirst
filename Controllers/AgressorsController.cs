...
namespace DatabaseFirst.Controllers
{
    public class AgressorsController : Controller
    {
        ...
        public AgressorsController(DatabaseEinsContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("AgressorId,AgressorName,AgressorEigenschaft")] Agressor agressor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AgressorId,AgressorName,AgressorEigenschaft")] Agressor agressor)
        {
